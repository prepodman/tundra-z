...
* #7. SAT-решатель
  ...
  Реализовать решатель булевых формул при помощи алгоритма DPLL с эвристиками распространения переменной и исключения чистых переменных. Формула для решения содержится в файле формата DIMACS.
